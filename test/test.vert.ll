...
entry:
  ...
  store <4 x float> %20, <4 x float>* %0, align 4
  %21 = alloca <3 x float>, align 16
  %22 = load <3 x float>, <3 x float>* @aPos, align 16
  store <3 x float> %22, <3 x float>* %21, align 16
  %23 = load <3 x float>, <3 x float>* @aPos, align 4
  %24 = extractelement <3 x float> %23, i64 2
  %25 = insertelement <1 x float> undef, float %24, i64 0
  %26 = extractelement <1 x float> %25, i64 0
  %27 = load <4 x float>, <4 x float>* %0, align 4
  ...
  store <4 x float> %29, <4 x float>* %0, align 4
  %30 = load <4 x float>, <4 x float>* %0, align 4
  %31 = alloca <4 x float>, align 16
  store <4 x float> %30, <4 x float>* %31, align 4
  %32 = load <4 x float>, <4 x float>* %31, align 16
  store <4 x float> %32, <4 x float>* @gl_Position, align 16
  ret void
}
